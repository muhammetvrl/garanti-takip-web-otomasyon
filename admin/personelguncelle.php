...
<body>
	...
	if ($result->num_rows > 0) {
		...
		while($row = $result->fetch_assoc()) {
			...
			<form action='personelguncelle1.php?id=".$row["personel_id"]."' method='POST' enctype='multipart/form-data' class='form-horizontal'>
			...
			<button type='reset' class='btn btn-danger btn-sm'><a href='personelguncelle.php'>
