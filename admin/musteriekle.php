	...
	<div class='col-md-10' style='margin: 50px 0 50px 8%;'>
		<div class='card'>
			...
			<div class='card-body card-block'>
				...
				<form action='musteriekle1.php' method='POST' enctype='multipart/form-data' class='form-horizontal'>
					...
					<div class='row form-group'>
						...
						<div class='col-12 col-md-9'><input type='text' id='text-input' name='ad' placeholder='Text' class='form-control'></div>

						<div class='col col-md-3'><label for='text-input' class=' form-control-label'><br>Soyad</label></div>
						<div class='col-12 col-md-9'><br><input type='text' id='text-input' name='soyad' placeholder='Text' class='form-control'></div>

						<div class='col col-md-3'><label for='text-input' class=' form-control-label'><br>Telefon</label></div>
						<div class='col-12 col-md-9'><br><input type='number' id='text-input' name='telefon' placeholder='Text' class='form-control'></div>

						<div class='col col-md-3'><label for='email-input' class=' form-control-label'><br>Email</label></div>
						<div class='col-12 col-md-9'><br><input type='email' id='email-input' name='email' placeholder='Enter Email' class='form-control'></div>

						<div class='col col-md-3'><label for='text-input' class=' form-control-label'><br>İl</label></div>
						<div class='col-12 col-md-9'><br><input type='text' id='text-input' name='il' placeholder='Text' class='form-control'></div>

						<div class='col col-md-3'><label for='text-input' class=' form-control-label'><br>İlçe</label></div>
						<div class='col-12 col-md-9'><br><input type='text' id='text-input' name='ilce' placeholder='Text' class='form-control'></div>

						<div class='col col-md-3'><label for='text-input' class=' form-control-label'><br>Kullanıcı Adı</label></div>
						<div class='col-12 col-md-9'><br><input type='text' id='text-input' name='kullaniciad' placeholder='Text' class='form-control'></div>
					</div>
